...
-(void)viewDidLoad{
    ...
    self.backButton = [[UIBarButtonItem alloc] initWithTitle:@"Register" style:UIBarButtonItemStylePlain target:self action:@selector(goBack)];
...
- (IBAction)noThanksAction {
    ...
    ReviewTransaction *next = [self.storyboard instantiateViewControllerWithIdentifier:@"review"];
